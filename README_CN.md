...
这是一个 **仅面向 [OMX](https://github.com/Yeachan-Heo/oh-my-codex) 用户** 的 Codex 风格增强包，用来把“分析类回答”的表层风格推近到更像 Opus 的呈现方式。
...
这个仓库是 **[OMX-only](https://github.com/Yeachan-Heo/oh-my-codex)**。

默认前提是你已经有：

- Codex Desktop 或 Codex CLI
- [`oh-my-codex`](https://github.com/Yeachan-Heo/oh-my-codex)
- 可工作的 [OMX](https://github.com/Yeachan-Heo/oh-my-codex) native hook 链路

这个仓库 **不尝试支持** 没有 [OMX](https://github.com/Yeachan-Heo/oh-my-codex) 的裸 Codex 环境。
